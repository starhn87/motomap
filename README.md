...
- 🏍️ **내 바이크**: 기종 검색 자동완성 1,040종 ([moto-kr](https://github.com/starhn87/moto-kr) 오픈소스 API). 등록하면 제원 도감 카드, 주유소에서 내 유종 강조와 가득 주유비, 리뷰 기종 뱃지, AI 추천 반영, 라이딩 기록(어디를 몇 번 갔는지 장소별로, 탭하면 지도의 그 장소로)까지 이어집니다
- 🛡️ **커뮤니티**: 신고와 차단, 회원 탈퇴
