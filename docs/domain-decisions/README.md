...
| 일반 장소의 라이더 추천 | [community-place-recommendations.md](community-place-recommendations.md) | `public.general_place_recommendations`, `components/map/TempPlaceSheet.tsx` |
