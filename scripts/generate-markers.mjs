...
// 원형에 가까운 상단에서 꼬리까지 하나의 연속된 3차 베지어 흐름으로 좁아진다.
// 원호와 별도 꼬리 곡선을 접붙이면 접선은 맞아도 곡률이 갑자기 달라져 경계가
// 뭉툭해 보인다. 상단 크기와 꼬리 끝은 유지하고 하단 전체의 곡률을 이어 준다.
const PIN_PATH =
  'M 20 2 C 11.16 2 4 9.16 4 18 C 4 27.25 10.35 31.1 14.65 35.15 C 17.05 37.42 18.72 40.08 20 42 C 21.28 40.08 22.95 37.42 25.35 35.15 C 29.65 31.1 36 27.25 36 18 C 36 9.16 28.84 2 20 2 Z';
