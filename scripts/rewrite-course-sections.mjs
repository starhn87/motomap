...
// 2차(왕복 정리): 경유지가 본선 도로 밖(선착장·해변 등)이면 들락거리는 가지가
// 생기므로 본선 위 분기점으로 옮기고, 왕복률 실측으로 겹침을 최소화했다.
//
// 사용:
...
const COURSES = [
  ...
  },
  {
    ...
    section_to: '탄도항',
    route_name: '대부황금로',
    coordinates: [[126.588, 37.256], [126.565, 37.225], [126.586, 37.19]],
  },
  {
  ...
  },
  {
    ...
    section_to: '입장면',
    route_name: null,
    coordinates: [[127.173, 36.833], [127.203, 36.913]],
  },
  {
    name: '강화도 일주 코스',
    section_from: '강화대교',
    section_to: '강화대교',
    route_name: '강화일주도로',
    coordinates: [[126.487, 37.747], [126.318, 37.788], [126.36, 37.71], [126.46, 37.622], [126.527, 37.644], [126.487, 37.747]],
  },
  {
    name: '용인-이천 카페 투어',
    section_from: '용인',
  ...
  },
  {
    ...
    section_to: '철원',
    route_name: '43번 국도',
    coordinates: [[127.162, 37.863], [127.4, 38.1]],
  },
  {
    name: '지리산 성삼재-정령치 코스',
    section_from: '구례',
  ...
  },
  {
    ...
    section_to: '물건리',
    route_name: '물미해안도로',
    coordinates: [[127.872, 34.9443], [128.045, 34.7133], [128.0533, 34.7698]],
  },
  {
    name: '제주 일주 코스',
    section_from: '제주공항',
  ...
  },
  {
    ...
    rename: '영남알프스 배내골 와인딩 코스',
    description:
      '언양에서 석남사 입구를 지나 배내고개를 넘어 배내골 계곡으로 내려가는 영남알프스 와인딩이에요. 배내고개 구간은 급커브가 이어지니 속도를 줄여 달리는 게 좋아요.',
    section_from: '언양',
    section_to: '배내골',
    route_name: '배내로',
    coordinates: [[129.0325, 35.621], [128.98, 35.5]],
  },
];
